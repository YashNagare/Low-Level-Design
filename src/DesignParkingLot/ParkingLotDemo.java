...
import DesignParkingLot.fee.VehicleBasedFeeStrategy;
import DesignParkingLot.parkingspot.ParkingSpot;
import DesignParkingLot.parkingspot.ParkingSpotFactory;
import DesignParkingLot.parkingspot.ParkingSpotType;
...
public class ParkingLotDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Car 1 is parked, Ticked id: " + parkingTicket1.getTicketId());
        ...
        // Unpark vehicles
        try {
            double fee = parkingLot.unparkVehicle(car1.getLicencePlate()); // valid ticket ID
            System.out.println("Vehicle: " + car1.getLicencePlate() + ", Fee: " + fee);
